                    ...
                    <div class="card-body pt-5">
                        <form method="POST" id="kt_stage_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('stages.store') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="text-muted mt-2">Total site percentage must be 100 or less.</div>
                            </div>

                            <div id="stage-rows">
                                @php
                                    $oldStages = old('stages', [['name' => '', 'percentage' => '']]);
                                @endphp
...
<script>
    $(document).ready(function() {
        let stageIndex = {{ count(old('stages', [['name' => '', 'percentage' => '']])) }};

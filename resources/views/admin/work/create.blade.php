...
<div class="toolbar bg-transparent pt-6 mb-5" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-3 flex-column mb-0">Add Work</h1>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-12">
                <div class="card card-flush h-lg-100" id="kt_work_form_main">
                    <div class="card-body pt-5">
                        <form method="POST" id="kt_work_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('works.store') }}">
                            @csrf
                            ...
                            <div class="row mb-7">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="name_of_work" value="{{ old('name_of_work') }}" placeholder="Enter Name Of Work" />
                                    @error('name_of_work')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="tender_id" value="{{ old('tender_id') }}" placeholder="Enter Tender ID" />
                                    @error('tender_id')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-7">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control form-control-solid" name="description_of_work" rows="3" placeholder="Enter Description of Work">{{ old('description_of_work') }}</textarea>
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select form-select-solid" name="equal_above_below_on_estimate" id="equal_above_below_on_estimate">
                                        ...
                                        <option value="0" {{ old('equal_above_below_on_estimate') == '0' ? 'selected' : '' }}>Equal (0)</option>
                                        <option value="+" {{ old('equal_above_below_on_estimate') == '+' ? 'selected' : '' }}>Above (+)</option>
                                        <option value="-" {{ old('equal_above_below_on_estimate') == '-' ? 'selected' : '' }}>Below (-)</option>
                                    </select>
                            ...
                            <div class="row mb-7">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="work_order_no" value="{{ old('work_order_no') }}" placeholder="Enter Work Order No." />
                                    @error('work_order_no')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control form-control-solid" name="wo_date" value="{{ old('wo_date') }}" />
                                    @error('wo_date')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control form-control-solid" name="work_start_date" value="{{ old('work_start_date') }}" />
                            ...
                            <div class="row mb-7">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control form-control-solid" name="end_date_of_work" value="{{ old('end_date_of_work') }}" />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid mt-3">
                                        <input class="form-check-input" type="checkbox" name="if_extend_date" id="if_extend_date" value="1" {{ old('if_extend_date') ? 'checked' : '' }} />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control form-control-solid" name="extended_date" id="extended_date" value="{{ old('extended_date') }}" />
                                    @error('extended_date')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>

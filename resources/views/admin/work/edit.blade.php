                        ...
                        <form method="POST" id="kt_work_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('works.update', $work->id) }}">
                            ...
                            <div class="row mb-7">
                                <div class="col-md-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control form-control-solid" name="add_18_percent_gst" id="add_18_percent_gst" value="{{ old('add_18_percent_gst', $work->add_18_percent_gst ?? 18) }}" placeholder="Enter GST %" />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control form-control-solid" name="gst_amount" id="gst_amount" value="{{ old('gst_amount', $work->gst_amount) }}" placeholder="Auto calculated" readonly />
                                    @error('gst_amount')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control form-control-solid" name="our_final_work_amt" id="our_final_work_amt" value="{{ old('our_final_work_amt', $work->our_final_work_amt) }}" placeholder="Auto calculated" readonly />

@section('title','Add GST Bill')
@extends('admin.layouts.main')
@section('main_contant')
<div class="toolbar bg-transparent pt-6 mb-5" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-3 flex-column mb-0">Add GST Bill</h1>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-10">
                <div class="card card-flush h-lg-100" id="kt_gst_bill_list_form_main">
                    <div class="card-body pt-5">
                        <form method="POST" id="kt_gst_bill_list_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('gst-bill-lists.store') }}">
                            @csrf
                            ...
                            <div class="row mb-7">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="party_name" value="{{ old('party_name') }}" placeholder="Enter Party Name" />
                                    @error('party_name')
                            ...
                            <div class="row mb-7">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select form-select-solid" name="is_inward_outward" data-control="select2" data-placeholder="Select Type...">
                                        ...
                                        <option value="Inward" {{ old('is_inward_outward') == 'Inward' ? 'selected' : '' }}>Inward</option>
                                        <option value="Outward" {{ old('is_inward_outward', 'Outward') == 'Outward' ? 'selected' : '' }}>Outward</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select form-select-solid" name="gst_slab" data-control="select2" data-placeholder="Select GST Slab...">
                                        ...
                                        <option value="5" {{ old('gst_slab') == '5' ? 'selected' : '' }}>5%</option>
                                        <option value="18" {{ old('gst_slab', '18') == '18' ? 'selected' : '' }}>18%</option>
                                    </select>
                                    @error('gst_slab')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="row mb-7">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="invoice_number" value="{{ old('invoice_number') }}" placeholder="Enter Invoice Number" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control form-control-solid" name="invoice_date" value="{{ old('invoice_date') }}" />
                                    @error('invoice_date')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-7">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="basic_amount" id="basic_amount" value="{{ old('basic_amount', 0) }}" step="0.01" min="0" placeholder="Enter Basic Amount" />
                                    @error('basic_amount')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="gst_amount" id="gst_amount" value="{{ old('gst_amount', 0) }}" step="0.01" min="0" placeholder="Enter GST Amount" />
                                    @error('gst_amount')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="total_bill_amount" id="total_bill_amount" value="{{ old('total_bill_amount', 0) }}" step="0.01" min="0" placeholder="Enter Total Bill Amount" />
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="ref_number" value="{{ old('ref_number') }}" placeholder="Enter Reference Number" />
                                    @error('ref_number')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control form-control-solid" name="payment_date" value="{{ old('payment_date') }}" />
                                    @error('payment_date')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-7">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="debit_from" value="{{ old('debit_from') }}" placeholder="Enter Debit From" />
                                    @error('debit_from')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>

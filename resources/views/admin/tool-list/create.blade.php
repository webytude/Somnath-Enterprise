                    ...
                    <div class="card-body pt-5">
                        <form method="POST" id="kt_tool_list_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('tool-lists.store') }}">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" name="shelf_location" value="{{ old('shelf_location') }}" placeholder="Enter Shelf / Rack Location (optional)" />
                            ...
                            <div class="row mb-7">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="person_name" value="{{ old('person_name') }}" placeholder="Enter Person Name" />
                                    @error('person_name')
                                        <span id="error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                    @enderror
                                </div>

@section('title','Manage Site Progress')
        ...
        <div class="card mb-5 mb-xl-12">
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <h1 class="d-flex text-dark fw-bolder fs-3 flex-column mb-0">Manage Site Progress</h1>
                </div>
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <a href="{{ route('site-progress.create') }}" type="button" class="btn btn-primary">
            ...
            <div class="card-body py-4">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_site_progress" style="min-width: 950px;">
                        <thead>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <form action="{{ route('site-progress.destroy', $progress) }}" method="POST" style="display:inline">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" onclick="return confirm('Are you sure you want to delete this site progress?')">
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">

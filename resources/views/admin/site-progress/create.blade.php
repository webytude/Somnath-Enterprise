                ...
                <div class="card card-flush h-lg-100" id="kt_site_progress_form_main">
                    <div class="card-body pt-5">
                        <form method="POST" id="kt_site_progress_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('site-progress.store') }}">
                            ...
                            <div class="mb-7">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control form-control-solid" name="stage_percentage" id="stage_percentage" value="{{ old('stage_percentage') }}" step="0.01" min="0" max="100" placeholder="Stage Percentage" readonly />
                            ...
                            <input type="hidden" name="work_site" id="work_site" value="" />
                            <input type="hidden" name="work_stage" id="work_stage" value="" />

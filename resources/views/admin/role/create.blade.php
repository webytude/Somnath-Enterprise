    ...
    <div id="kt_content_container" class="container-fluid">
        <div class="card">
            <div class="card-header border-0 pt-6">
                <h1 class="d-flex text-dark fw-bolder fs-3 flex-column mb-0">Create Role</h1>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('roles.store') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" class="form-control form-control-solid" name="name" value="{{ old('name') }}" required />
                    </div>
                    <div class="mb-5">

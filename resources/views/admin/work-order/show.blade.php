                ...
                <div class="card card-flush h-lg-100">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h2 class="fw-bolder mb-0">Work Order Details</h2>
                        </div>
                    </div>
                    <div class="card-body pt-3">
                        ...
                        <div class="mb-10">
                            <div class="d-flex align-items-center mb-5">
                                <span class="bullet bullet-vertical h-40px bg-primary me-4"></span>
                                <h3 class="text-gray-800 fw-bolder mb-0">VENDOR</h3>
                            </div>
                            <div class="row g-5 mb-7">
                                <div class="col-12 col-lg-6">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5" style="min-width: 900px;">
                                    <thead>
                                        <tr>
                                            <th>Sr.</th>
                                            <th>Work Details</th>
                        ...
                        <div class="mb-10">
                            <div class="d-flex align-items-center mb-5">
                                <span class="bullet bullet-vertical h-40px bg-primary me-4"></span>
                                <h3 class="text-gray-800 fw-bolder mb-0">VENDOR PAYMENTS</h3>
                            </div>
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5" style="min-width: 700px;">
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                            <th>Amt. (Payable)</th>
                        ...
                        <div class="mb-10">
                            <div class="d-flex align-items-center mb-5">
                                <span class="bullet bullet-vertical h-40px bg-primary me-4"></span>
                                <h3 class="text-gray-800 fw-bolder mb-0">LOCATION &amp; WORK</h3>
                            </div>
                            <div class="row g-5 mb-7">
                                <div class="col-12 col-lg-6">

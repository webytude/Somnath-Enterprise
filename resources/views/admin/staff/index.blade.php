        ...
        <div class="card mb-5 mb-xl-12">
            ...
            <div class="card-body py-4">
                ...
                <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-bold mb-5">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10" data-bs-toggle="tab" href="#kt_tab_daily_expense">
                            <span class="svg-icon svg-icon-2 me-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="tab-content" id="kt_tab_content">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_staff">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($s->photo)
                                            <img src="{{ $s->photo }}" alt="{{ $s->full_name }}" class="w-50px h-50px rounded" style="object-fit: cover;">
                                        @else
                                            <div class="symbol symbol-50px">
                                                <div class="symbol-label fs-2 fw-semibold text-success bg-light-success">{{ substr($s->first_name, 0, 1) }}</div>
                                            </div>
                                        @endif
                                    </td>
                                    <td>{{ $s->full_name }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @php
                                                        ...
                                                        $attendance = $attendances[$s->id] ?? null;
                                                        $currentStatus = $attendance ? $attendance->attendance_status : 'absent';
                                                    @endphp
                                                    <select 
                    ...
                    <!-- Daily Expense Tab -->
                    <div class="tab-pane fade" id="kt_tab_daily_expense" role="tabpanel">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <h3 class="mb-0">
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_daily_expenses">
                                        ...
                                        <tbody class="text-gray-600 fw-bold">
                                            ...
                                            @empty
                                            <tr>
                                                <td colspan="{{ (!auth()->check() || !auth()->user()->isStaff()) ? '6' : '5' }}" class="text-center">No daily expenses found.</td>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
    ...
    $(document).ready(function() {
        ...
        function updatePresentCount() {
            ...
            $('.attendance-status-select').each(function() {
                ...
                if (status === 'present' || status === 'present_with_bike') {
                    presentCount++;
                }
            });

                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_contractors">
                        <thead>
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">Payment Slab</th>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>{{ $contractor->amount ? '₹' . number_format($contractor->amount, 2) : 'N/A' }}</td>
                                <td>{{ $contractor->remaining_amount ? '₹' . number_format($contractor->remaining_amount, 2) : 'N/A' }}</td>
                                <td>{{ $contractor->paymentSlab->name ?? 'N/A' }}</td>
                                <td class="text-end">
